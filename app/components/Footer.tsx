        ...
        <div className="mx-auto max-w-7xl">
              ...
              <div className="mt-5 flex gap-2">
                {[
                  ...
                  <a
                    ...
                    aria-label={label}
                    className="flex h-9 w-9 items-center justify-center rounded-[8px] border border-black/10 text-black/40 transition hover:border-[var(--modulus-primary)]/30 hover:bg-[var(--modulus-primary)]/8 hover:text-[var(--modulus-primary)]"
                  >
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-black/8 pt-8 sm:flex-row">
            ...
            <div className="flex items-center gap-1.5 text-xs text-black/35">
              <span>Feito com</span>
              <svg width="11" height="11" viewBox="0 0 24 24" fill="var(--modulus-primary)" stroke="none">
