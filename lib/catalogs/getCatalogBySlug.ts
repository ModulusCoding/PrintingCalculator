          ...
          for (const item of catalogProducts) {
            ...
            if (rawProd && rawProd.active !== false) {
              products.push({
                ...
                name: rawProd.name,
                category: rawProd.category || "Geral",
                format: rawProd.format || "Unitário",
                detail: rawProd.detail || `${rawProd.category || "Geral"} · Impresso sob demanda`,
                description: rawProd.description,
                photo: rawProd.image_url || "/images/catalogo/mod-001-luminaria-shoji.webp",
                photoSecondary: rawProd.photo_secondary_url || null,
                photoAlt: rawProd.name,
                photoSecondaryAlt: rawProd.photo_secondary_alt || null,
                photoNote: rawProd.photo_note || null,
